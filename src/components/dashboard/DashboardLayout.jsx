...
const navItems = [
  ...
  { href: "/dashboard/orders", label: "My Orders", icon: FiShoppingBag },
  { href: "/dashboard/wishlist", label: "Wishlist", icon: FiHeart },
  { href: "/dashboard/addresses", label: "Addresses", icon: FiMapPin },
  {
  ...
  { href: "/dashboard/messages", label: "Messages", icon: FiMail },
  { href: "/dashboard/reviews", label: "Reviews", icon: FiStar },
  { href: "/dashboard/support", label: "Support Tickets", icon: FiHelpCircle },
];
